...
const TilePattern = ({ suit, value }: { suit: TileSuit, value: TileValue }) => {
    ...
    if (suit === 'dots') {
        ...
        switch (value) {
            ...
            case '2': return <svg viewBox="0 0 50 70"><g transform="translate(0, 5)"><Dot color={greenColor} cx="25" cy="18" /><Dot cx="25" cy="42" /></g></svg>;
