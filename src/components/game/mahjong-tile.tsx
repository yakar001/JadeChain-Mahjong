...
const TilePattern = ({ suit, value }: { suit: TileSuit, value: TileValue }) => {
    ...
    if (suit === 'bamboo') {
        ...
        switch (value) {
            ...
            case '2': return <svg viewBox="0 0 50 70"><g transform="translate(25, 35) scale(1.6)"><Stick color={redColor} transform="translate(0, -9)" /><Stick color={greenColor} transform="translate(0, 9)" /></g></svg>;
            case '3': return <svg viewBox="0 0 50 70"><g transform="translate(25, 35) scale(1.6)"><Stick color={redColor} transform="translate(0, -12)" /><Stick color={greenColor} transform="translate(-7, 9)" /><Stick color={greenColor} transform="translate(7, 9)" /></g></svg>;
            ...
            case '6': return <svg viewBox="0 0 50 70"><g transform="translate(25, 35) scale(1.6)"><Stick color={redColor} transform="translate(-7, -12)" /><Stick color={redColor} transform="translate(7, -12)" /><Stick color={greenColor} transform="translate(-7, 0)" /><Stick color={greenColor} transform="translate(7, 0)" /><Stick color={greenColor} transform="translate(-7, 12)" /><Stick color={greenColor} transform="translate(7, 12)" /></g></svg>;
            case '7': return <svg viewBox="0 0 50 70"><g transform="translate(25, 35) scale(1.5)"><Stick color={redColor} transform="translate(0, -18)" /><Stick color={greenColor} transform="translate(-8, -3)" /><Stick color={greenColor} transform="translate(0, -3)" /><Stick color={greenColor} transform="translate(8, -3)" /><Stick color={greenColor} transform="translate(-8, 12)" /><Stick color={greenColor} transform="translate(0, 12)" /><Stick color={greenColor} transform="translate(8, 12)" /></g></svg>;
            case '8': return <svg viewBox="0 0 50 70"><g transform="translate(25, 35) scale(1.5)"><g transform="translate(0, -11)"><path d="M -10 -8 l 5 8 l -5 8 M 0 -8 l 5 8 l -5 8 M 10 -8 l 5 8 l -5 8" stroke={greenColor} strokeWidth="2.5" fill="none" strokeLinecap="round" strokeLinejoin="round"/></g><g transform="translate(0, 11)"><path d="M -10 -8 l 5 8 l -5 8 M 0 -8 l 5 8 l -5 8 M 10 -8 l 5 8 l -5 8" stroke={greenColor} strokeWidth="2.5" fill="none" strokeLinecap="round" strokeLinejoin="round"/></g></g></svg>;
