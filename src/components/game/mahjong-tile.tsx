...
const TilePattern = ({ suit, value }: { suit: TileSuit, value: TileValue }) => {
    ...
    if (suit === 'dots') {
        ...
        switch (value) {
            ...
            case '4': return <svg viewBox="0 0 50 70"><g transform="translate(0, 5)"><Dot color={blueColor} cx="18" cy="18" /><Dot color={greenColor} cx="32" cy="18" /><Dot color={greenColor} cx="18" cy="42" /><Dot color={blueColor} cx="32" cy="42" /></g></svg>;
            ...
            case '6': return <svg viewBox="0 0 50 70"><g transform="translate(0, 5)"><Dot color={redColor} cx="18" cy="18" /><Dot color={redColor} cx="32" cy="18" /><Dot color={greenColor} cx="18" cy="30" /><Dot color={greenColor} cx="32" cy="30" /><Dot color={greenColor} cx="18" cy="42" /><Dot color={greenColor} cx="32" cy="42" /></g></svg>;
            case '7': return <svg viewBox="0 0 50 70"><g transform="translate(0, 5)"><g transform="rotate(10 25 25) translate(0, -5)"><Dot color={greenColor} cx="17" cy="15" /><Dot color={greenColor} cx="25" cy="22" /><Dot color={greenColor} cx="33" cy="29" /></g><Dot color={redColor} cx="18" cy="38" /><Dot color={redColor} cx="32" cy="38" /><Dot color={redColor} cx="18" cy="50" /><Dot color={redColor} cx="32" cy="50" /></g></svg>;
