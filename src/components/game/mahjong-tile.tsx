...
const TilePattern = ({ suit, value, size }: { suit: TileSuit, value: TileValue, size: 'md' | 'sm' }) => {
    ...
    if (suit === 'dots') {
        ...
        switch (value) {
            ...
            case '4': return <div className="w-full h-full flex justify-center items-center"><div className="grid grid-cols-2 grid-rows-2 p-1 gap-x-2 gap-y-1">{dots(2, dotColor)}{dots(2, greenColor)}</div></div>;
            ...
            case '7': return <div className="w-full h-full flex flex-col justify-center items-center p-1 gap-0.5"><div className="flex justify-between w-4/5 -mb-1"><div className="transform -rotate-45 -translate-x-1">{dots(1, greenColor)}</div><div className="transform translate-y-px">{dots(1, greenColor)}</div><div className="transform rotate-45 translate-x-1">{dots(1, greenColor)}</div></div><div className="flex justify-around w-full">{dots(2, redColor)}</div><div className="flex justify-around w-full">{dots(2, redColor)}</div></div>;
    ...
    if (suit === 'bamboo') {
        ...
        switch (value) {
            ...
            case '8': return <div className="w-full h-full flex flex-col justify-center items-center gap-1"><div className="flex gap-4"><div className={cn(sizeClass.bamboo, "rotate-45")}/><div className={cn(sizeClass.bamboo, "-rotate-45")}/></div><div className="flex gap-2"><div className={cn(sizeClass.bamboo, "-rotate-45")}/><div className={cn(sizeClass.bamboo, "rotate-45")}/></div><div className="flex gap-4"><div className={cn(sizeClass.bamboo, "rotate-45")}/><div className={cn(sizeClass.bamboo, "-rotate-45")}/></div></div>;
