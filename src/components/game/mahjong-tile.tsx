...
const TilePattern = ({ suit, value }: { suit: TileSuit, value: TileValue }) => {
    ...
    if (suit === 'dots') {
        ...
        switch (value) {
            ...
            case '2': return <svg viewBox="0 0 50 70"><Dot color={redColor} cx="25" cy="18" /><Dot color={greenColor} cx="25" cy="52" /></svg>;
            case '3': return <svg viewBox="0 0 50 70"><Dot color={blueColor} cx="15" cy="15" /><Dot color={redColor} cx="25" cy="35" /><Dot color={greenColor} cx="35" cy="55" /></svg>;
            case '4': return <svg viewBox="0 0 50 70"><Dot color={blueColor} cx="17" cy="17" /><Dot color={greenColor} cx="33" cy="17" /><Dot color={greenColor} cx="17" cy="53" /><Dot color={blueColor} cx="33" cy="53" /></svg>;
            case '5': return <svg viewBox="0 0 50 70"><Dot color={blueColor} cx="15" cy="15" /><Dot color={greenColor} cx="35" cy="15" /><Dot color={redColor} cx="25" cy="35" /><Dot color={greenColor} cx="15" cy="55" /><Dot color={blueColor} cx="35" cy="55" /></svg>;
            case '6': return <svg viewBox="0 0 50 70"><g transform="translate(0, 2)"><Dot color={redColor} cx="17" cy="15" /><Dot color={redColor} cx="33" cy="15" /><Dot color={greenColor} cx="17" cy="34" /><Dot color={greenColor} cx="33" cy="34" /><Dot color={greenColor} cx="17" cy="53" /><Dot color={greenColor} cx="33" cy="53" /></g></svg>;
            case '7': return <svg viewBox="0 0 50 70"><g transform="translate(0, -2)"><g transform="rotate(10 25 25)"><Dot color={greenColor} cx="17" cy="15" /><Dot color={greenColor} cx="25" cy="22" /><Dot color={greenColor} cx="33" cy="29" /></g><Dot color={redColor} cx="17" cy="42" /><Dot color={redColor} cx="33" cy="42" /><Dot color={redColor} cx="17" cy="58" /><Dot color={redColor} cx="33" cy="58" /></g></svg>;
    ...
    if (suit === 'bamboo') {
        ...
        switch (value) {
            ...
            case '6': return <svg viewBox="0 0 50 70"><g transform="translate(25, 35) scale(0.7)"><Stick color={greenColor} transform="translate(-8, -18)" /><Stick color={greenColor} transform="translate(8, -18)" /><Stick color={redColor} transform="translate(-8, 0)" /><Stick color={redColor} transform="translate(8, 0)" /><Stick color={blueColor} transform="translate(-8, 18)" /><Stick color={blueColor} transform="translate(8, 18)" /></g></svg>;
