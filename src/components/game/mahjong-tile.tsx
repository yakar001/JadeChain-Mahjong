...
const TilePattern = ({ suit, value }: { suit: TileSuit, value: TileValue }) => {
    ...
    if (suit === 'dots') {
        const Dot = ({ color = blueColor, cx, cy }: { color?: string, cx: number, cy: number }) => (
         ...
         const MultiCircle = ({ color = blueColor, cx, cy }: { color?:string, cx: number, cy: number }) => (
            <g>
                <circle cx={cx} cy={cy} r="6" fill={color} />
        ...
        switch (value) {
            ...
            case '2': return <svg viewBox="0 0 50 70"><g transform="translate(0, 5)"><MultiCircle color={greenColor} cx="25" cy="18" /><MultiCircle color={redColor} cx="25" cy="42" /></g></svg>;
            case '3': return <svg viewBox="0 0 50 70"><g transform="translate(0, 5)"><MultiCircle color={blueColor} cx="16" cy="16" /><MultiCircle color={redColor} cx="25" cy="30" /><MultiCircle color={greenColor} cx="34" cy="44" /></g></svg>;
            case '4': return <svg viewBox="0 0 50 70"><g transform="translate(0, 5)"><MultiCircle color={blueColor} cx="18" cy="18" /><MultiCircle color={greenColor} cx="32" cy="18" /><MultiCircle color={greenColor} cx="18" cy="42" /><MultiCircle color={blueColor} cx="32" cy="42" /></g></svg>;
            case '5': return <svg viewBox="0 0 50 70"><g transform="translate(0, 5)"><MultiCircle color={blueColor} cx="16" cy="16" /><MultiCircle color={greenColor} cx="34" cy="16" /><MultiCircle color={redColor} cx="25" cy="30" /><MultiCircle color={greenColor} cx="16" cy="44" /><MultiCircle color={blueColor} cx="34" cy="44" /></g></svg>;
            case '6': return <svg viewBox="0 0 50 70"><g transform="translate(0, 5)"><MultiCircle color={redColor} cx="18" cy="18" /><MultiCircle color={redColor} cx="32" cy="18" /><MultiCircle color={greenColor} cx="18" cy="30" /><MultiCircle color={greenColor} cx="32" cy="30" /><MultiCircle color={greenColor} cx="18" cy="42" /><MultiCircle color={greenColor} cx="32" cy="42" /></g></svg>;
            case '7': return <svg viewBox="0 0 50 70"><g transform="translate(0, 5)"><g transform="rotate(10 25 25) translate(0, -5)"><MultiCircle color={greenColor} cx="17" cy="15" /><MultiCircle color={greenColor} cx="25" cy="22" /><MultiCircle color={greenColor} cx="33" cy="29" /></g><MultiCircle color={redColor} cx="18" cy="38" /><MultiCircle color={redColor} cx="32" cy="38" /><MultiCircle color={redColor} cx="18" cy="50" /><MultiCircle color={redColor} cx="32" cy="50" /></g></svg>;
            case '8': return <svg viewBox="0 0 50 70"><g transform="translate(0, 5)"><MultiCircle color={blueColor} cx="18" cy="14" /><MultiCircle color={blueColor} cx="32" cy="14" /><MultiCircle color={blueColor} cx="18" cy="24" /><MultiCircle color={blueColor} cx="32" cy="24" /><MultiCircle color={blueColor} cx="18" cy="34" /><MultiCircle color={blueColor} cx="32" cy="34" /><MultiCircle color={blueColor} cx="18" cy="44" /><MultiCircle color={blueColor} cx="32" cy="44" /></g></svg>;
            case '9': return <svg viewBox="0 0 50 70"><g transform="translate(0, 5)"><MultiCircle color={greenColor} cx="17" cy="15" /><MultiCircle color={greenColor} cx="25" cy="15" /><MultiCircle color={greenColor} cx="33" cy="15" /><MultiCircle color={redColor} cx="17" cy="30" /><MultiCircle color={redColor} cx="25" cy="30" /><MultiCircle color={redColor} cx="33" cy="30" /><MultiCircle color={blueColor} cx="17" cy="45" /><MultiCircle color={blueColor} cx="25" cy="45" /><MultiCircle color={blueColor} cx="33" cy="45" /></g></svg>;
            default: return null;
        }
    }
    ...
    if (suit === 'bamboo') {
        ...
        switch (value) {
            ...
            case '2': return <svg viewBox="0 0 50 70"><g transform="translate(25, 35) scale(0.7)"><Stick color={greenColor} transform="translate(0, -13)" /><Stick color={redColor} transform="translate(0, 13)" /></g></svg>;
            case '3': return <svg viewBox="0 0 50 70"><g transform="translate(25, 35) scale(0.7)"><Stick color={greenColor} transform="translate(0, -18)" /><Stick color={blueColor} transform="translate(-10, 10)" /><Stick color={redColor} transform="translate(10, 10)" /></g></svg>;
            case '4': return <svg viewBox="0 0 50 70"><g transform="translate(25, 35) scale(0.7)"><Stick color={blueColor} transform="translate(-8, -13)" /><Stick color={greenColor} transform="translate(8, -13)" /><Stick color={greenColor} transform="translate(-8, 13)" /><Stick color={redColor} transform="translate(8, 13)" /></g></svg>;
            ...
            case '7': return <svg viewBox="0 0 50 70"><g transform="translate(25, 35) scale(0.65)"><Stick color={redColor} transform="translate(0, -22)" /><Stick color={greenColor} transform="translate(-10, -2)" /><Stick color={greenColor} transform="translate(10, -2)" /><Stick color={blueColor} transform="translate(-10, 18)" /><Stick color={greenColor} transform="translate(0, 18)" /><Stick color={blueColor} transform="translate(10, 18)" /></g></svg>;
            case '8': return <svg viewBox="0 0 50 70"><g transform="translate(25, 35) scale(0.65)"><g transform="translate(0, -15)"><path d="M -12 -8 L -6 0 L -12 8 M 0 -8 L 6 0 L 0 8 M 12 -8 L 18 0 L 12 8" stroke={greenColor} strokeWidth="4" fill="none" strokeLinecap="round" strokeLinejoin="round"/></g><g transform="translate(0, 15)"><path d="M -12 -8 L -6 0 L -12 8 M 0 -8 L 6 0 L 0 8 M 12 -8 L 18 0 L 12 8" stroke={redColor} strokeWidth="4" fill="none" strokeLinecap="round" strokeLinejoin="round"/></g></g></svg>;
