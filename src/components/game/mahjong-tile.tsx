...
const TilePattern = ({ suit, value }: { suit: TileSuit, value: TileValue }) => {
    ...
    if (suit === 'bamboo') {
        ...
        switch (value) {
            ...
            case '3': return <svg viewBox="0 0 50 70"><g transform="translate(25, 35) scale(0.7)"><Stick color={greenColor} transform="translate(0, -18)" /><Stick color={blueColor} transform="translate(-8, 13)" /><Stick color={redColor} transform="translate(8, 13)" /></g></svg>;
